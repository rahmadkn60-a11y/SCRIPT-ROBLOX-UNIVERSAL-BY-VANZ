...
local parryDebounce = 0.25
local parryDebounceMap = {}
local autoParryLastFire = 0
local autoParryFireCooldown = 0.01
...
makeInfo("Combat: Anti-Ragdoll + Auto Parry (Hyper Instant)", cb)
makeToggle(
    "Anti Ragdoll",
    false,
    function(state)
...
print("[vanz] Slim menu + Hyper Instant Auto Parry")
