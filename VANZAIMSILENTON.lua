...
local function hookGunRemote(remote)
    if not remote or silentAimRemoteHooks[remote] then return end
...
local function scanForGunRemotes()
    ...
    for _, obj in ipairs(remotesFolder:GetDescendants()) do
        if obj:IsA("RemoteEvent") or obj:IsA("RemoteFunction") then
            ...
            if n:find("fire") or n:find("shot") or n:find("shoot") or n:find("hit") or n:find("attack") or n:find("bullet") or n:find("damage") then
                hookGunRemote(obj)
            end
        end
    end
...
makeInfo("Camera: override kamera. Mouse: override Mouse.Hit. Remote: hook remote senjata. Hybrid: semua sekaligus.", sb)
...
makeToggle("Ring Visual", true, function(state)
    ...
    if not state then destroyParryRing() else createParryRing() end
end, cb)
